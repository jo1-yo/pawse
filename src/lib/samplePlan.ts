...
export function getSamplePlan(): Plan {
  ...
  return {
    ...
    events,
    summary:
      "Here's a calm, doable week. 🐱 Your CS project is broken into morning focus blocks, the history essay is finished a day before it's due, and classes stay put. You've got this.",
    warnings: [],
  };
}
